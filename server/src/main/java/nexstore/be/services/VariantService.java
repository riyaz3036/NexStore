...
import nexstore.be.dtos.Variant.CreateVariantDTO;
import nexstore.be.dtos.Variant.UpdateVariantDTO;
import nexstore.be.dtos.Variant.VariantFilterDTO;
import nexstore.be.dtos.Variant.VariantResponseDTO;
import nexstore.be.entities.BaseEntity;
...
import nexstore.be.repositories.VariantRepository;
import nexstore.be.uploads.FileUploadService;
