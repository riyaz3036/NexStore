...
import nexstore.be.dtos.Product.ExpandedProductDTO;
...
import nexstore.be.dtos.Variant.*;
import nexstore.be.dtos.swagger.variant.VariantObjectResponseDTO;
import nexstore.be.dtos.swagger.variant.VariantArrayResponseDTO;
import nexstore.be.dtos.swagger.variant.VariantPaginationResponseDTO;
